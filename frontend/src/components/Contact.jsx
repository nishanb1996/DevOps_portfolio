            ...
            <Card.Body className="p-4">
              ...
              <div className="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <p className="mb-0">
                    <a href="mailto:nishanbansode25@outlook.com" style={{ textDecoration: 'none', color: 'inherit' }}>
                      nishanbansode25@outlook.com
                    </a>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-0">
                    <a href="https://www.linkedin.com/in/nishan-bansode-875b561a9/" target="_blank" rel="noopener noreferrer">
                      linkedin.com/in/nishan-bansode
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <p className="mb-0">
                    <a href="https://github.com/nishanb1996" target="_blank" rel="noopener noreferrer">
                      github.com/nishanb1996
                    </a>
                  </p>
                </div>
              </div>
